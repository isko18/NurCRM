...
# Интервалы/лимиты
INBOX_INTERVAL_ACTIVE = float(os.getenv("IG_INBOX_ACTIVE", "5.0"))
INBOX_INTERVAL_IDLE   = float(os.getenv("IG_INBOX_IDLE", "2.0"))
THREAD_POLL_INTERVAL  = float(os.getenv("IG_THREAD_POLL", "0.6"))
