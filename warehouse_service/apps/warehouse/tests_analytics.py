...
class WarehousePartnerAnalyticsTests(TestCase):
    def setUp(self):
        ...
        self.owner_b = User.objects.create_user(email="ownerb@example.com", password="pass123")
        ...
        # Документ создан в обход post_document — пересчитываем total, иначе
        # аналитика (Sum("total")) даст 0.
        warehouse_services.recalc_document_totals(d)
